...
<body>
    ...
    <%
        try{
        Map<String, String> userMap = (Map<String, String>) application.getAttribute("adminMap");
...
<div id="menu">
    <a href="adminPaneli.jsp" target="_self" onclick="resetMenu()">Ana Menü</a>
    <a href="#" onclick="loadPage('dersOzellikBilgileri.jsp')">Dersler Özellikleri</a>
    <a href="#" onclick="loadPage('dersMenu.jsp')">Dersler</a>
    <a href="#" onclick="loadPage('bolumDersProgramiMenu.jsp')">Bölüm Ders Programi</a>
    <a href="#" onclick="loadPage('ogrenciBilgileri.jsp')">Öğrenci Bilgileri</a>
    <a href="#" onclick="loadPage('ogretimElemaniBilgileri.jsp')">Öğretim Elemanı Bilgileri</a>
    <a href="#" onclick="loadPage('sifreDegistir.jsp?rol=admin')">Şifre Değiştir</a>
