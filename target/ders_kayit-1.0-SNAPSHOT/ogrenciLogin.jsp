...
<body>
    ...
    <form action="VT_giris.jsp" method="post" onsubmit="return validateForm()">
        ...
        <a href="VT_ogrenciSifre.jsp"><button type="button" name="role" value="ogrenci">Şifremi Unuttum</button></a>
    </form>
