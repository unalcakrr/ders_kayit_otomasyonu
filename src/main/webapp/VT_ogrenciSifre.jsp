    ...
    <script>
        ...
        function validateForm() {
            ...
            if (!validUsername.test(username)) {
                alert("Kullanıcı adı sadece harf veya sayı içerebilir!");
                return false;
            }
...
<body>
    <form action="VT_sifre.jsp" method="post" onsubmit="return validateForm()">
        <label for="username">Kullanıcı Adı:</label>
        <input type="text" name="username" id="username" required maxlength="20">
        <br>

        <label for="mail">E-Mail:</label>
        <input type="text" name="mail" id="mail" required maxlength="50">
        <br>
